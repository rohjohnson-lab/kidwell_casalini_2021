...
ggsave("single cell RNA SEQ May 2019/figures/vlnQC-prefilter.png")
...
ggsave("single cell RNA SEQ May 2019/figures/vlnQC-postfilter.png")
...
plot_grid(p1, p2)
ggsave("single cell RNA SEQ May 2019/figures/pca_original_cluster.png")
```
...
plot_grid(p1, p2)
ggsave("single cell RNA SEQ May 2019/figures/umap_original_cluster.png")
...
plot_grid(p1, p2)
ggsave("single cell RNA SEQ May 2019/figures/tsne_original_cluster.png")


#Plots if splitting up condition (either tSNE or uMAP)
DimPlot(mitotransfer.combined, reduction = "umap", split.by = "condition")
ggsave("single cell RNA SEQ May 2019/figures/umap_clusters_split_by_sample.png")
DimPlot(mitotransfer.combined, reduction = "tsne", split.by = "condition")
ggsave("single cell RNA SEQ May 2019/figures/umap_labels_split_by_sample.png")
```
...
```{r}
saveRDS(mitotransfer.combined, file = "single cell RNA SEQ May 2019/data/R_analysis/mitotransfer_combined_cocultureonly.rds")
```

From here, I'll re-load in the RDS object and continue my analysis.

```{r}
mitotransfer.combined <- readRDS("single cell RNA SEQ May 2019/data/R_analysis/mitotransfer_combined_cocultureonly.rds")
```
...
ggsave("single cell RNA SEQ May 2019/figures/heatmap_TAM_only_gene_signature.png")
...
#ggsave(filename = "single cell RNA SEQ May 2019/figures/umap_unlabelled_plot_legend.png")
```
...
#ggsave(filename = "single cell RNA SEQ May 2019/figures/umap_labelled_plot_legend_by_condition.png")
```
...
plot_grid(p1, p2)
#ggsave("single cell RNA SEQ May 2019/figures/mda_only_umap.png")

p1 <- DimPlot(mda_cells, reduction = "tsne", group.by = "condition")
p2 <- DimPlot(mda_cells, reduction = "tsne", label = TRUE)
plot_grid(p1, p2)
#ggsave("single cell RNA SEQ May 2019/figures/mda_only_tsne.png")

DimPlot(mda_cells, reduction = "umap", split.by = "condition")
#ggsave("single cell RNA SEQ May 2019/figures/mda_only_umap_condition_split.png")
DimPlot(mda_cells, reduction = "tsne", split.by = "condition")
#ggsave("single cell RNA SEQ May 2019/figures/mda_only_tsne_condition_split.png")
```
...
plot_grid(p1, p2)
#ggsave("single cell RNA SEQ May 2019/figures/mac_only_umap.png")

p1 <- DimPlot(mac_cells, reduction = "tsne", group.by = "condition")
p2 <- DimPlot(mac_cells, reduction = "tsne", label = TRUE)
plot_grid(p1, p2)
#ggsave("single cell RNA SEQ May 2019/figures/mac_only_tsne.png")

DimPlot(mac_cells, reduction = "umap", split.by = "condition")
#ggsave("single cell RNA SEQ May 2019/figures/mac_only_umap_condition_split.png")
...
fwrite(x = mda_only_condition_1v2.markers, row.names = TRUE, file = "single cell RNA SEQ May 2019/data/R_analysis/mda_only_conditions_transfer1vsnotransfer2_nocc_15npcs.csv")
```

#Visualize the differentially expressed genes with a volcano plot
...
ggsave(filename = "single cell RNA SEQ May 2019/figures/DE_volcano_plot_mda_only_transfervsnotransfer_labelled_ckdesign.png", dpi = 300, type="cairo-png", units = "in")
```

I will then use this differential expression dataset and process it using the Ingenuity pathway analysis software by Qiagen.
